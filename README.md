...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-mqtt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12221&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-mqtt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-mqtt` can be installed with:

```
conda install yaqd-mqtt
```

It is possible to list all of the versions of `yaqd-mqtt` available on your platform with:
